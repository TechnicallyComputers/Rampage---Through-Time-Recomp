...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Rampage - Through Time",
    .project_root_env = "RAMPAGE___THROUGH_TIME_RECOMP_PROJECT_ROOT",
    .build_dir_env = "RAMPAGE___THROUGH_TIME_RECOMP_BUILD_DIR",
    .force_setup_env = "RAMPAGE___THROUGH_TIME_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_010.65_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Rampage___Through_Time__Recompiled",
    .prepare_note =
